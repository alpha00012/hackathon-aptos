                    ...
                    <div className="row ">
                        <div className="col-xl-6 col-lg-5 col-md-12 ">
                            <div className="tf-heading style-2 wow fadeInUp">
                                ...
                                <p className="sub-heading">At Binabox, we are dedicated to revolutionizing the event management industry by leveraging the power of blockchain technology and NFTs. Our platform ensures transparency, security, and efficiency for event organizers and participants alike.</p>
                            </div>
                            ...
                            <Link href="/about1" className="tf-button style-2 wow fadeInUp">LEARN MORE</Link>
                        </div>
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-6">
                                    <div className="tf-step wow fadeInUp" data-wow-delay="0.3s">
                                        ...
                                        <p>Our platform supports a wide variety of events, ensuring there is something for everyone.</p>
                                    </div>
                                </div>
                                <div className="col-md-6">
